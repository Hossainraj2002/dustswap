...
> **User Safety Note**
> None of the above are available to buy, claim, or pre-register for today. Treat any offer that says otherwise as a scam, and watch official channels (the app and the official Discord) for real announcements.
