...
export function ReferralPageClient({ params }: ReferralPageClientProps) {
  ...
  const [message, setMessage] = useState(
    "Connect your wallet to save this referral code."
  );
  ...
  useEffect(() => {
    ...
    setState("saved");
    setMessage(
      "Invite code saved. Complete your first onchain check-in or PP claim to activate it."
    );
  ...
  }, [address, isConnected, referralCode, router]);
    ...
    >
      <div className="mx-auto flex w-full max-w-xl flex-col gap-3">
        <section className="rounded-[28px] border border-white/70 bg-white/88 p-5 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            After your first onchain check-in or PP claim, this invite can activate
            and both you and the person who referred you can receive 500 PP.
          </p>
