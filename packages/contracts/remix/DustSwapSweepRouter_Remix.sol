...
// ─────────────────────────────────────────────────────────────────────────────
// DustSwapSweepRouter (DustSweep V3) — flattened single-file build for Remix.
// Generated with `forge flatten`. Do NOT edit here; edit
// src/DustSwapSweepRouter.sol and re-flatten instead.
//
// REMIX / BaseScan VERIFY SETTINGS (use these EXACTLY for first-try verification):
