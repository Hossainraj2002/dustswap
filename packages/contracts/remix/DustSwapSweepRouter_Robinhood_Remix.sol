...
// ─────────────────────────────────────────────────────────────────────────────
// DustSwapSweepRouterRobinhood (DustSweep V3 — Robinhood Chain) — flattened single-file build
// for Remix. Robinhood Chain (chainId 4663) adaptation of DustSwapSweepRouter_Remix.sol (which
// is kept unchanged). Identical logic and external ABI; only the contract name differs.
// Robinhood's native gas token IS ETH and its wrapped native is literally WETH
// (0x0Bd7D308f8E1639FAb988df18A8011f41EAcAD73, verified live 2026-07-26: symbol()=WETH,
// decimals()=18), so — unlike the BSC build's wbnb/IWBNB rename — the weth/IWETH9 naming and
// every "native ETH" comment stay verbatim: they are factually correct on this chain.
//
// REMIX / Blockscout (robinhoodchain.blockscout.com) VERIFY SETTINGS (use these EXACTLY for
